...
/**
 * @brief TreeModel::setUpModelData sets up the model when the data comes from
 * a QString
 * @param stringData
 */
void TreeModel::setUpModelData(const QString & stringData)
{
    ...
    tmpString.remove(0, 1); // Removes the first open bracket
    tmpString.remove(len - 1, 1); // removes the last closed bracket
